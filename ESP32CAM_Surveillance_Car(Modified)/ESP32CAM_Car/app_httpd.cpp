...
static esp_err_t index_handler(httpd_req_t *req){
 ...
 //page += "<p align=center><IMG SRC='http://" + WiFiAddr + ":81/stream' style='width:280px;'></p><br/><br/9>";
 page += "<p align=center><IMG SRC='http://" + WiFiAddr + ":81/stream' style='width:650px; transform:rotate(360deg);'></p><br/><br/>";
